...
<form action="" id="supplier-form">
			...
			<div class="form-group">
                ...
                <input name="name" id="name" type="varchar" class="form-control rounded-0" value="<?php echo isset($name) ? $name : ''; ?>" onkeydown="return allowOnlyLetters(event)" required required>
			</div>
			<div class="form-group">
				<label for="sup_contact" class="control-label">Contact</label>
                <input name="sup_contact" id="sup_contact" type="text" class="form-control rounded-0" value="<?php echo isset($sup_contact) ? $sup_contact: ''; ?>" onkeydown="return allowOnlyNumbers(event)" maxlength="11" required required>
			</div>
