...
$cancelled = $conn->query("SELECT * FROM `order_list` where client_id = '{$_settings->userdata('id')}' and status = 1 order by unix_timestamp(date_created) desc ");
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td class="text-center"><?= number_format($row['total_amount'], 2) ?></td>
                                                    <td class="text-center">
                                                        <span class="badge badge-secondary px-3 rounded-pill p-2 bg-success">Shipped</span>
                                                    </td>
                                                    <td class="text-center">
                                                        <button class="btn btn-flat btn-sm btn-default border view_data" type="button" data-id="<?= $row['id'] ?>"><i class="fa fa-eye"></i> View</button>
                                                    </td>
